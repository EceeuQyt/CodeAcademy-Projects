...
months = ['October', 'September', 'September', 'November', 'August', 'September', 'September', 'September', 'September', 
        ...
        'September', 'August', 'October', 'September', 'September', 'July', 'August', 'September', 'October', 'August', 'September', 
...
# Convert all list into single Dictionarty
...
# Creates a dictionary of hurricanes selected by specific year from key.
hurricanes_by_year = year_dict(hurricanes)
print(hurricanes_by_year[2017])
print(hurricanes_by_year[1955])
print()

# Counting Damaged Areas
def count_affected(hurricanes):
...
# Creates a dictionary of areas to store the number of hurricanes involved in
affected_areas_count = count_affected(hurricanes)
...
def most_affected_area(affected_areas_count):
    ...
    max_area = affected_areas_count.keys()
    max_area_count = 0
...
# Finds most frequently affected area and the number of hurricanes involved in
...
def highest_mortality(hurricanes):
    max_mortality_cane = hurricanes.keys()
    max_mortality = 0
    for cane in hurricanes:
...
# Finds highest mortality hurricane and the number of deaths
...
#Categorize hurricanes by mortality using a Dict_scale to return and append to correct values.
    mortality_scale =  {0: 0,
                    1: 100,
                    2: 500,
                    3: 1000,
...
# Categorizes hurricanes in new dictionary with mortality Scale, select specific rating between 1 and 5
...
def highest_damage(hurricanes):
    #Finds the highest damage inducing hurricane and its total cost.
    max_damage_cane = hurricanes.keys()
    max_damage = 0
    for cane in hurricanes:
...
# Finds highest damage inducing hurricane and its total cost
...
def categorize_by_damage(hurricanes):
    #Categorizes hurricanes by damage and return a dictionary.
    damage_scale = {0: 0,
                    1: 100000000,
                    2: 1000000000,
                    3: 10000000000,
...
# Categorizes hurricanes in new dictionary with damage severity as key
